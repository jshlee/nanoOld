...
private: 
      ...
      std::vector<Float_t> b_b_Jet_CSVV2;
      ...
      Float_t b_eleffweight;
      Float_t b_eleffweight_up;
      Float_t b_eleffweight_dn;

      Float_t b_btagweight_up;
      Float_t b_btagweight_dn;
      ...
      //Channel
      Int_t b_nvertex, b_channel, b_nlep, b_nmuon, b_nelec, b_njet, b_nbjet;
      Bool_t keep;
